...
class Test64(unittest.TestCase):
    ...
    def test_wikipedia_example(self):
        hex_ = "4d616e"
        expected = "TWFu"
        self.assertEqual(hex_to_base64(hex_), expected, "Should be " + expected)
    ...
    def test_example_with_library(self):
        hex_ = b"49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d"
        expected = "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t"
        decoded = base64.b64decode(expected)
        self.assertEqual(hexlify(decoded), hex_)
